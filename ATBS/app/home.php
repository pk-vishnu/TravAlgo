...
<section id="hero">
  <div class="container">
    <div class="row">
      <div class="col">
		<br><br>
        <h1>TravAlgo<br>Ticket Booking</h1>
      ...
      <div class="col-md-4 d-flex justify-content-center">
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            ...
            <p class="card-text">Algorand Blockhain integrated with the TravAlgo booking system build towards a sustainable eco0friendly system!</p>
          </div>
        </div>
      </div>
